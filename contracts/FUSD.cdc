...
pub contract FUSD: FungibleToken {
    ...
    init() {
        ...
        // todo: stupid question. So this Administrator can only be created in this init stage, right? 
        // So this cannot be created from outside, for example, a transaction?
        // todo: check how resource can be created? Is it like, the resource should be firstly created in the Contract Init, can only be further created by calling functions of such resource?
        let admin <- create Administrator()
        // todo: I have to do this as workaround
