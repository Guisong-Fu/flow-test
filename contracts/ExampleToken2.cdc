...
pub contract ExampleToken2: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT {
        ...
        // todo: which means we shall come up with our rule for metadata.
        
        pub var metadata: {String: String} // todo: why is this var? but Id is let?
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            let token <- token as! @ExampleToken2.NFT
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}) {
            ...
            var newNFT <- create NFT(initID: ExampleToken2.totalSupply)
            
            // todo: what? So the totalSupply can start from whatever? It does not have to start from 1?
            ExampleToken2.totalSupply = ExampleToken2.totalSupply + UInt64(1)
